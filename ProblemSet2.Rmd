...
```{r}
knitr::kable(mytable, col.names = c("R", "D", "Open Seat", "Challenger", "Incumbent"))

summarise(avg ) |> 
  n = "promote_prop"
na.rm = TRUE 

"party_incombent_promote"


knitr::kable(my_table, col.names = c("R", "D", "Open Seat", "Challenger", "Incumbent"))
