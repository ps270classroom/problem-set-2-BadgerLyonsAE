...
fb_top_plot <- ggplot(house_top_15,
                      mapping = aes(x = impressions_millions, y = 
fct_reorder(cand_name_last, impressions_millions))) +
  geom_col(mapping = aes(fill = party)) +
    scale_fill_manual(values = c(D = "steelblue", R = "red")) +
  labs(title = "Top 15 US House Canidates By Facebook Ad Impressions, 2017 - 2018" , x = "Facebook Ad Impressions in Millions", Y = "")
